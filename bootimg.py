...
__all__ = ['Memcpy', 'BootEnc', 'OTPID', 'BootParamError', 'BootParam']
...
class Memcpy(NamedTuple):
    ...
    def __getitem__(self, s: slice):
        ...
        return type(self)(addr, len(view), view)
...
class BootParam(NamedTuple):
    ...
    def __repr__(self):
        return (
            ...
            'extra_size={0.extra_size:#x}, boot_enc_flag={0.boot_enc_flag:#x}, '
    ...
    def parse_v1(cls, image: 'ReadableBuffer'):
        ...
        boot_enc_flag = uint32(view, 0x210)
    ...
    def parse_v2(cls, image: 'ReadableBuffer'):
        ...
        boot = Memcpy.cut(
            unchecked.end, uint32(view, 0x2fe4) - asc.end - unchecked.size,
            view, offset)
    ...
    def parse_v3(cls, image: 'ReadableBuffer'):
        ...
        boot_enc_flag = uint32(view, 0x10210)
    ...
    def parse_v4(cls, image: 'ReadableBuffer'):
        ...
        boot_enc_flag = uint32(view, 0x210)
        offset = 0 if boot_enc_flag == BootEnc.NO_ENC else 0x10000
        view = view[offset:]
...
def main():
    ...
    if not args.dd:
        ...
        print(
            ...
            'Boot enc flag       : {0.boot_enc_flag:#x}\n'
